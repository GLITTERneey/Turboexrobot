...
buttons = [
    [
        InlineKeyboardButton(text="✨𝐔𝐩𝐝𝐚𝐭𝐞𝐬 𝐂𝐡𝐚𝐧𝐧𝐞𝐥✨", url="https://t.me/storeglitter"),
        InlineKeyboardButton(text="✨𝐔𝐩𝐝𝐚𝐭𝐞𝐬 𝐆𝐫𝐨𝐮𝐩✨", url="https://t.me/Virtualllnihsad"),
    ],
    [
        InlineKeyboardButton(text="🃏 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 🃏", url="https://t.me/Biarenakliatnyaaa"),
        InlineKeyboardButton(text="❔ 𝐇𝐞𝐥𝐩", url="http://t.me/Biarenakbott?start=help"),
    ],
    [
        InlineKeyboardButton(
...
Support them  [Rio](t.me/fckualot)"""
